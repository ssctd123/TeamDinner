const resetPassword = function (token, firstName) {
    const html = `
    <!DOCTYPE html>
...
<body
  ...
  <div style="display: none;">A request to reset password was received from your TeamDinner Account</div>
  <div role="article" aria-roledescription="email" aria-label="Reset your Password" lang="en">
                  ...
                  <tr>
                    <td class="sm-px-24"
                      ...
                      <p style="margin: 0 0 16px;">
                        ...
                        <a href="mailto:teamdinner995@gmail.com" class="hover-underline"
                          style="--text-opacity: 1; color: #7367f0; text-decoration: none;">teamdinner995@gmail.com</a>.
                      </p>
                    </td>
                  </tr>
                  <tr>
    ...
    const text = `
        Reset Password, You recently requested to reset your password for your TeamDinner account. Copy and paste it for reset password:
        ${token}
